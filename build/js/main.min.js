...
var initCoachesSwiper = function initCoachesSwiper() {
  if (coachesSwiper) {
    (function () {
      return new _swiper.default('.coaches__swiper', {
...
},{"../js/vendor/swiper.js":18}],2:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initMenuScroll = void 0;
var buttonHeaderServices = document.querySelector('.header__services');
...
exports.initMenuScroll = initMenuScroll;
...
require("./vendor/iphone-inline-video");
require("./vendor/swiper");
var _blogSlider = require("./blog-slider");
var _reviewsSlide = require("./reviews-slide");
var _initTabs = require("./modules/tabs/init-tabs");
var _playVideo = require("./play-video");
var _initMenuScroll = require("./initMenuScroll");
window.addEventListener('DOMContentLoaded', function () {
  (0, _initTabs.initTabs)();
  (0, _iosVhFix.iosVhFix)();
  (0, _blogSlider.initCoachesSwiper)();
  (0, _reviewsSlide.initReviewsSwiper)();
  (0, _playVideo.initPlayVideo)();
  (0, _initMenuScroll.initMenuScroll)();
...
},{"./blog-slider":1,"./initMenuScroll":2,"./modules/form-validate/form":5,"./modules/tabs/init-tabs":11,"./play-video":13,"./reviews-slide":14,"./utils/ios-vh-fix":16,"./vendor/iphone-inline-video":17,"./vendor/swiper":18}],4:[function(require,module,exports){
"use strict";
...
var buttonPlay = document.querySelector('.promo__video-play');
var picturePromo = document.querySelector('.promo__picture-video');
var promoShadow = document.querySelector('.promo__shadow');
var promoContainerButton = document.querySelector('.promo__container-button');
var promoContainerVideo = document.querySelector('.promo__container-video');
var iframeVideo = document.querySelector('.promo__video');
...
var coachesSwiper = document.querySelector('.reviews__swiper');
...
},{"../js/vendor/swiper.js":18}],15:[function(require,module,exports){
"use strict";
